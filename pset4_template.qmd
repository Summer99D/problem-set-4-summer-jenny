...
zip_shapes = gpd.read_file("/Users/samarnegahdar/Desktop/untitled folder/problem-set-4-summer-jenny/gz_2010_us_860_00_500k")
...
texas_zip_shapes = zip_shapes[zip_shapes['ZCTA5CE10'].str.startswith(('75', '76', '77', '78', '79'))]

# Step 3: Load the 2016 POS dataset and filter for Texas hospitals
# Assuming `all_years_data` is a DataFrame containing the cleaned POS data
pos2016 = all_years_data[(all_years_data['YEAR'] == 2016)]

# Calculate the number of hospitals per ZIP code in Texas for 2016
hospitals_per_zip = pos2016['ZIP_CD'].value_counts().reset_index()
hospitals_per_zip.columns = ['ZIP_CD', 'hospital_count']

# Step 4: Merge the hospital counts with the Texas ZIP code shapefile
# Ensure ZIP code columns are strings for consistent merging
texas_zip_shapes['ZCTA5CE10'] = texas_zip_shapes['ZCTA5CE10'].astype(str)
hospitals_per_zip['ZIP_CD'] = hospitals_per_zip['ZIP_CD'].astype(str)
texas_zip_shapes = texas_zip_shapes.merge(hospitals_per_zip, left_on='ZCTA5CE10', right_on='ZIP_CD', how='left')

# Step 5: Plot the choropleth map
fig, ax = plt.subplots(1, 1, figsize=(10, 10))
texas_zip_shapes.plot(column='hospital_count', cmap='Blues', linewidth=0.8, ax=ax, edgecolor='0.8', legend=True)
